                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li><a href="?page=bobot_kriteria">Bobot Kriteria</a></li>
                            <li><a href="?page=sub_kriteria">Sub Kriteria</a></li>
                            <li class="divider"></li>
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="?page=lap_seluruh">Seluruh Siswa</a></li>
                            <li><a href="?page=lap_persiswa">Per Siswa</a></li>
